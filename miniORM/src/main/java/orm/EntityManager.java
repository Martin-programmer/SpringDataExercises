...
import orm.annutation.Column;
import orm.annutation.Entity;
import orm.annutation.Id;
...
public class EntityManager<E> implements DBContext<E> {
    ...
    public E findFirst(Class<E> table, String where) throws IllegalArgumentException, SQLException, InstantiationException, IllegalAccessException {
